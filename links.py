...
CT_DISAMBIGUATION = {
  ...
  ("609" , 32,  8, None) : ("P220655", 3),
  ("614" ,  7, 34,  "b") : ("P108540", 2),
  ("647" , 32,  8, None) : ("P220655", 3),
  ("739" ,  7, 32,  "b") : ("P108536", 2),
  ("753" , 10, 49,  "c") : ("P108654", 4),
  ("754" ,  7, 18,  "a") : ("P108507", 2),
  ("770" ,  7, 31,  "b") : ("P108534", 2),
  ("800" ,  7, 32,  "b") : ("P108536", 2),
}
